		...
		<div class="interface-wrapper">
			...
			<div class="login">
				<form action="loginCookies.php" method="POST" class="login-form" autocomplete="off" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
					...
					<?php
						setcookie('invalid[username]', '', time() - 100, '/');
						endif;
					?>
					<div class="login-form-box">
					...
					<?php
						setcookie('invalid[password]', '', time() - 100, '/');
						endif;
					?>
			...
			<div class="messages">
				...
				<div class="messages-box">
					<h3 class="messages-data">
						<span class="messages-name"><?= $index++ . ". $mensaje->name"?></span> | <span class="messages-date"><?= $mensaje->dateMod ?></span> | <span class="messages-time"><?= $mensaje->time ?></span>
					</h3>
